/*Policeman will be able to catch the thief if the thief is k place away from thief
otherwise thief will not be caught,count the number of times thieves that can be caught*/
#include <iostream>
#include <vector>
#include <cmath>
using namespace std;
